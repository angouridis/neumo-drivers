...
static void demux_worker(unsigned long data)
{
	...
	do {
		...
		neumo_dvb_dmx_swfilter(demux, data, 348 * 188);
...
static int vp1028_dvbs_set_voltage(struct neumo_dvb_frontend *fe, enum fe_sec_voltage voltage)
{
...
static int skystar2_set_voltage(struct neumo_dvb_frontend *fe,
...
static int skystar2_voltage_boost(struct neumo_dvb_frontend *fe, long arg)
{
	int err;
	u8 value;
...
static int saa716x_tbs6284_frontend_attach(struct saa716x_adapter *adapter, int count)
{
	...
	if (!i2c_client_has_driver(client)) {
		neumo_dvb_frontend_detach(adapter->fe);
		goto err2;
	}
...
static void tbs6922_lnb_power(struct neumo_dvb_frontend *fe, int onoff)
{
	...
	struct saa716x_adapter *adapter, int count)
{
	...
	adapter->fe = dvb_attach(tas2101_attach, &tbs6922_cfg,
													 &dev->i2c[SAA716x_I2C_BUS_A].i2c_adapter, rf_in);
	if (adapter->fe == NULL)
		goto err;
...
static void tbs6923_lnb_power(struct neumo_dvb_frontend *fe, int onoff)
{
	struct i2c_adapter *adapter = tas2101_get_i2c_adapter(fe, 0);
	struct saa716x_i2c *i2c = i2c_get_adapdata(adapter);
	struct saa716x_dev *dev = i2c->saa716x;
...
static int tbs6925_set_voltage(struct neumo_dvb_frontend *fe, enum fe_sec_voltage voltage)
{
...
static void tbs6982_reset_fe(struct neumo_dvb_frontend *fe, int reset_pin)
{
	struct i2c_adapter *adapter = tas2101_get_i2c_adapter(fe, 0);
        struct saa716x_i2c *i2c = i2c_get_adapdata(adapter);
        struct saa716x_dev *dev = i2c->saa716x;
...
static void tbs6982_reset_fe0(struct neumo_dvb_frontend *fe)
{
	tbs6982_reset_fe(fe, 2);
}

static void tbs6982_reset_fe1(struct neumo_dvb_frontend *fe)
{
	tbs6982_reset_fe(fe, 17);
}

static void tbs6982_lnb_power(struct neumo_dvb_frontend *fe,
...
static void tbs6982_lnb0_power(struct neumo_dvb_frontend *fe, int onoff)
{
	tbs6982_lnb_power(fe, 5, onoff);
}

static void tbs6982_lnb1_power(struct neumo_dvb_frontend *fe, int onoff)
{
	...
	struct saa716x_adapter *adapter, int count)
{
	...
	adapter->fe = dvb_attach(tas2101_attach, &tbs6982_cfg[count],
													 &dev->i2c[1 - count].i2c_adapter, rf_in);
	if (adapter->fe == NULL)
		goto err;
...
static void tbs6982se_reset_fe(struct neumo_dvb_frontend *fe, int reset_pin)
{
	struct i2c_adapter *adapter = tas2101_get_i2c_adapter(fe, 0);
        struct saa716x_i2c *i2c = i2c_get_adapdata(adapter);
        struct saa716x_dev *dev = i2c->saa716x;
...
static void tbs6982se_reset_fe0(struct neumo_dvb_frontend *fe)
{
	tbs6982se_reset_fe(fe, 2);
}

static void tbs6982se_reset_fe1(struct neumo_dvb_frontend *fe)
{
	tbs6982se_reset_fe(fe, 17);
}

static void tbs6982se_lnb_power(struct neumo_dvb_frontend *fe,
	int enpwr_pin, int onoff)
{
	struct i2c_adapter *adapter = tas2101_get_i2c_adapter(fe, 0);
        struct saa716x_i2c *i2c = i2c_get_adapdata(adapter);
...
static void tbs6982se_lnb0_power(struct neumo_dvb_frontend *fe, int onoff)
{
	tbs6982se_lnb_power(fe, 3, onoff);
}

static void tbs6982se_lnb1_power(struct neumo_dvb_frontend *fe, int onoff)
{
	...
	struct saa716x_adapter *adapter, int count)
{
	...
	adapter->fe = dvb_attach(tas2101_attach, &tbs6982se_cfg[count],
													 &dev->i2c[count].i2c_adapter, rf_in);
	if (adapter->fe == NULL)
		goto err;
...
static void tbs6984_lnb_pwr(struct neumo_dvb_frontend *fe, int pin, int onoff)
{
...
static void tbs6984_lnb_pwr0(struct neumo_dvb_frontend *fe, int demod, int onoff)
{
	tbs6984_lnb_pwr(fe, (demod == 0) ? 19 : 2, onoff);
}

static void tbs6984_lnb_pwr1(struct neumo_dvb_frontend *fe, int demod, int onoff)
{
...
static void tbs6985_reset_fe(struct neumo_dvb_frontend *fe, int reset_pin)
{
	struct i2c_adapter *adapter = tas2101_get_i2c_adapter(fe, 0);
        struct saa716x_i2c *i2c = i2c_get_adapdata(adapter);
        struct saa716x_dev *dev = i2c->saa716x;
...
static void tbs6985_reset_fe0(struct neumo_dvb_frontend *fe)
{
	tbs6985_reset_fe(fe, 5);
}

static void tbs6985_reset_fe1(struct neumo_dvb_frontend *fe)
{
	tbs6985_reset_fe(fe, 2);
}

static void tbs6985_reset_fe2(struct neumo_dvb_frontend *fe)
{
	tbs6985_reset_fe(fe, 13);
}

static void tbs6985_reset_fe3(struct neumo_dvb_frontend *fe)
{
	tbs6985_reset_fe(fe, 3);
}

static void tbs6985_lnb_power(struct neumo_dvb_frontend *fe,
	int enpwr_pin, int onoff)
{
	struct i2c_adapter *adapter = tas2101_get_i2c_adapter(fe, 0);
        struct saa716x_i2c *i2c = i2c_get_adapdata(adapter);
...
static void tbs6985_lnb0_power(struct neumo_dvb_frontend *fe, int onoff)
{
	tbs6985_lnb_power(fe, 27, onoff);
}

static void tbs6985_lnb1_power(struct neumo_dvb_frontend *fe, int onoff)
{
	tbs6985_lnb_power(fe, 22, onoff);
}

static void tbs6985_lnb2_power(struct neumo_dvb_frontend *fe, int onoff)
{
	tbs6985_lnb_power(fe, 19, onoff);
}

static void tbs6985_lnb3_power(struct neumo_dvb_frontend *fe, int onoff)
{
...
static int saa716x_tbs6985_frontend_attach(struct saa716x_adapter *adapter, int count)
{
	...
	adapter->fe = dvb_attach(tas2101_attach, &tbs6985_cfg[count],
													 &dev->i2c[1 - (count >> 1)].i2c_adapter, rf_in);
	if (adapter->fe == NULL)
		goto err;
...
static void tbs6991_reset_fe(struct neumo_dvb_frontend *fe, int reset_pin)
{
	struct i2c_adapter *adapter = tas2101_get_i2c_adapter(fe, 0);
        struct saa716x_i2c *i2c = i2c_get_adapdata(adapter);
        struct saa716x_dev *dev = i2c->saa716x;
...
static void tbs6991_reset_fe0(struct neumo_dvb_frontend *fe)
{
	tbs6991_reset_fe(fe, 20);
}

static void tbs6991_reset_fe1(struct neumo_dvb_frontend *fe)
{
	tbs6991_reset_fe(fe, 17);
}

static void tbs6991_lnb_power(struct neumo_dvb_frontend *fe,
	int enpwr_pin, int onoff)
{
	struct i2c_adapter *adapter = tas2101_get_i2c_adapter(fe, 0);
        struct saa716x_i2c *i2c = i2c_get_adapdata(adapter);
...
static void tbs6991_lnb0_power(struct neumo_dvb_frontend *fe, int onoff)
{
	tbs6991_lnb_power(fe, 5, onoff);
}

static void tbs6991_lnb1_power(struct neumo_dvb_frontend *fe, int onoff)
{
...
static int saa716x_tbs6983_set_voltage(struct neumo_dvb_frontend *fe, enum fe_sec_voltage voltage)
{
	struct saa716x_adapter *adapter = fe->dvb->priv;
	struct saa716x_dev *saa716x = adapter->saa716x;
