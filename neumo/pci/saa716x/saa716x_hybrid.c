...
static int tda1004x_vp6090_request_firmware(struct neumo_dvb_frontend *fe,
...
static int vp6090_dvbs_set_voltage(struct neumo_dvb_frontend *fe, enum fe_sec_voltage voltage)
{
...
static int tda1004x_atlantis_request_firmware(struct neumo_dvb_frontend *fe,
					      const struct firmware **fw,
					      char *name)
{
	struct saa716x_adapter *adapter = fe->dvb->priv;
...
static int tda1004x_nemo_request_firmware(struct neumo_dvb_frontend *fe,
					  const struct firmware **fw,
					  char *name)
{
	struct saa716x_adapter *adapter = fe->dvb->priv;
