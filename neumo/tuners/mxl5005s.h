...
extern struct neumo_dvb_frontend *mxl5005s_attach(struct neumo_dvb_frontend *fe,
					    struct i2c_adapter *i2c,
					    struct mxl5005s_config *config);
#else
static inline struct neumo_dvb_frontend *mxl5005s_attach(struct neumo_dvb_frontend *fe,
					    struct i2c_adapter *i2c,
					    struct mxl5005s_config *config)
{
