...
struct mt2060_platform_data {
	...
	struct neumo_dvb_frontend *dvb_frontend;
};
...
extern struct neumo_dvb_frontend * mt2060_attach(struct neumo_dvb_frontend *fe, struct i2c_adapter *i2c, struct mt2060_config *cfg, u16 if1);
#else
static inline struct neumo_dvb_frontend * mt2060_attach(struct neumo_dvb_frontend *fe, struct i2c_adapter *i2c, struct mt2060_config *cfg, u16 if1)
{
