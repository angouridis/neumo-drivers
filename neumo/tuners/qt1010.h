...
extern struct neumo_dvb_frontend *qt1010_attach(struct neumo_dvb_frontend *fe,
					  struct i2c_adapter *i2c,
					  struct qt1010_config *cfg);
#else
static inline struct neumo_dvb_frontend *qt1010_attach(struct neumo_dvb_frontend *fe,
						 struct i2c_adapter *i2c,
						 struct qt1010_config *cfg)
{
