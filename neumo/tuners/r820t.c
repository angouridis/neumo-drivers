...
static int generic_set_freq(struct neumo_dvb_frontend *fe,
			    u32 freq /* in HZ */,
			    unsigned bw,
			    enum v4l2_tuner_type type,
			    v4l2_std_id std, u32 delsys)
...
static int r820t_init(struct neumo_dvb_frontend *fe)
{
	struct r820t_priv *priv = fe->tuner_priv;
	int rc;
...
static int r820t_sleep(struct neumo_dvb_frontend *fe)
{
	struct r820t_priv *priv = fe->tuner_priv;
	int rc;
...
static int r820t_set_analog_freq(struct neumo_dvb_frontend *fe,
...
static int r820t_set_params(struct neumo_dvb_frontend *fe)
{
	struct r820t_priv *priv = fe->tuner_priv;
...
static int r820t_signal(struct neumo_dvb_frontend *fe, u16 *strength)
{
	struct r820t_priv *priv = fe->tuner_priv;
	int rc = 0;
...
static int r820t_get_if_frequency(struct neumo_dvb_frontend *fe, u32 *frequency)
{
	struct r820t_priv *priv = fe->tuner_priv;
...
static void r820t_release(struct neumo_dvb_frontend *fe)
{
	struct r820t_priv *priv = fe->tuner_priv;
...
static const struct neumo_dvb_tuner_ops r820t_tuner_ops = {
	.info = {
...
struct neumo_dvb_frontend *r820t_attach(struct neumo_dvb_frontend *fe,
																				struct i2c_adapter *i2c,
																				const struct r820t_config *cfg, int rf_in)
{
