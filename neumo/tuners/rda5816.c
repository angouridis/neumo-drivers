...
static int rda5816_init(struct neumo_dvb_frontend *fe)
{
...
static int rda5816_get_status(struct neumo_dvb_frontend *fe, u32 *status)
{
	struct rda5816_priv *priv = fe->tuner_priv;
...
static void rda5816_release(struct neumo_dvb_frontend* fe)
{
	struct rda5816_priv*priv = fe->tuner_priv;
...
static const struct neumo_dvb_tuner_ops rda5816_tuner_ops = {
	.info = {
		.name           = "RDA5816",
...
struct neumo_dvb_frontend *rda5816_attach(struct neumo_dvb_frontend *fe,
