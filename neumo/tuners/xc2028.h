...
extern struct neumo_dvb_frontend *xc2028_attach(struct neumo_dvb_frontend *fe,
					  struct xc2028_config *cfg);
#else
static inline struct neumo_dvb_frontend *xc2028_attach(struct neumo_dvb_frontend *fe,
						 struct xc2028_config *cfg)
{
