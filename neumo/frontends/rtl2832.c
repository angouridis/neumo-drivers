...
static int rtl2832_set_if(struct neumo_dvb_frontend *fe, u32 if_freq)
{
...
static int rtl2832_init(struct neumo_dvb_frontend *fe)
{
	struct rtl2832_dev *dev = fe->demodulator_priv;
	struct i2c_client *client = dev->client;
	struct neumo_dtv_frontend_properties *c = &dev->fe.dtv_property_cache;
...
static int rtl2832_sleep(struct neumo_dvb_frontend *fe)
{
	struct rtl2832_dev *dev = fe->demodulator_priv;
	struct i2c_client *client = dev->client;
	int ret;
...
static int rtl2832_get_tune_settings(struct neumo_dvb_frontend *fe,
...
static int rtl2832_set_frontend(struct neumo_dvb_frontend *fe)
{
	struct rtl2832_dev *dev = fe->demodulator_priv;
	struct i2c_client *client = dev->client;
...
static int rtl2832_get_frontend(struct neumo_dvb_frontend *fe,
...
static int rtl2832_read_status(struct neumo_dvb_frontend *fe, enum fe_status *status)
{
	struct rtl2832_dev *dev = fe->demodulator_priv;
	struct i2c_client *client = dev->client;
	struct neumo_dtv_frontend_properties *c = &fe->dtv_property_cache;
...
static int rtl2832_read_snr(struct neumo_dvb_frontend *fe, u16 *snr)
{
	struct neumo_dtv_frontend_properties *c = &fe->dtv_property_cache;
...
static int rtl2832_read_ber(struct neumo_dvb_frontend *fe, u32 *ber)
{
	struct rtl2832_dev *dev = fe->demodulator_priv;
...
static const struct neumo_dvb_frontend_ops rtl2832_ops = {
	.delsys = { SYS_DVBT },
	.info = {
...
static struct neumo_dvb_frontend *rtl2832_get_dvb_frontend(struct i2c_client *client)
{
...
static int rtl2832_pid_filter_ctrl(struct neumo_dvb_frontend *fe, int onoff)
{
	struct rtl2832_dev *dev = fe->demodulator_priv;
	struct i2c_client *client = dev->client;
	int ret;
...
static int rtl2832_pid_filter(struct neumo_dvb_frontend *fe, u8 index, u16 pid,
			      int onoff)
{
	struct rtl2832_dev *dev = fe->demodulator_priv;
	struct i2c_client *client = dev->client;
...
static int rtl2832_probe(struct i2c_client *client)
{
	...
	/* create dvb_frontend */
	memcpy(&dev->fe.ops, &rtl2832_ops, sizeof(struct neumo_dvb_frontend_ops));
