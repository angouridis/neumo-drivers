...
extern struct neumo_dvb_frontend *cxd2841er_attach_s(struct cxd2841er_config *cfg,
					       struct i2c_adapter *i2c);

extern struct neumo_dvb_frontend *cxd2841er_attach_t_c(struct cxd2841er_config *cfg,
					       struct i2c_adapter *i2c);
#else
static inline struct neumo_dvb_frontend *cxd2841er_attach_s(
...
static inline struct neumo_dvb_frontend *cxd2841er_attach_t_c(
