/*
    Tmas TAS2971 - DVBS/S2 Satellite demod/tuner driver
...
#ifndef TAS2971_PRIV_H
#define TAS2971_PRIV_H
...
enum tas2971_lnb_power {
	LNB_OFF = 0,
	LNB_ON  = 1,
};

struct tas2971_regtable {
	u8 addr;
	u8 setmask;
	u8 clrmask;
	int sleep;
