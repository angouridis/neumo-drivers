 ...
 *
 *
 * Copyright (C) 2023-2025 Deep Thought <deeptho@gmail.com>: blindscan, spectrum, constellation code
 ...
 */
#ifdef UNUSED
static void si5351_drive_strength(struct m88rs6060_state *dev, enum si5351_clock clk, enum si5351_drive drive)
{
	u8 reg_val;
