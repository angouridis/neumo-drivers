...
static int mn88473_get_tune_settings(struct neumo_dvb_frontend *fe,
...
static int mn88473_set_frontend(struct neumo_dvb_frontend *fe)
{
...
static int mn88473_read_status(struct neumo_dvb_frontend *fe, enum fe_status *status)
{
	struct i2c_client *client = fe->demodulator_priv;
	struct mn88473_dev *dev = i2c_get_clientdata(client);
	struct neumo_dtv_frontend_properties *c = &fe->dtv_property_cache;
...
static int mn88473_init(struct neumo_dvb_frontend *fe)
{
	struct i2c_client *client = fe->demodulator_priv;
	struct mn88473_dev *dev = i2c_get_clientdata(client);
	struct neumo_dtv_frontend_properties *c = &fe->dtv_property_cache;
...
static int mn88473_sleep(struct neumo_dvb_frontend *fe)
{
	struct i2c_client *client = fe->demodulator_priv;
	struct mn88473_dev *dev = i2c_get_clientdata(client);
	int ret;
...
static const struct neumo_dvb_frontend_ops mn88473_ops = {
