...
static const struct neumo_dvb_tuner_ops si2168_ops;
...
static int mxl603_init(struct neumo_dvb_frontend *fe)
{
...
static int mxl603_set_params(struct neumo_dvb_frontend *fe)
{
	struct i2c_client *client =fe->tuner_priv;
	struct mxl603_dev *dev = i2c_get_clientdata(client);
...
static int mxl603_get_status(struct neumo_dvb_frontend *fe,u32*status)
{
	struct i2c_client *client =fe->tuner_priv;
	struct mxl603_dev *dev = i2c_get_clientdata(client);
	int ret;
...
static const struct neumo_dvb_tuner_ops mxl603_ops ={
	.info = {
...
static int mxl603_probe(struct i2c_client *client)
{
	...
	/**/
	memcpy(&fe->ops.tuner_ops,&mxl603_ops,sizeof(struct neumo_dvb_tuner_ops));
