...
static R848_Freq_Info_Type R848_Freq_Sel(u32 LO_freq, u32 RF_freq,R848_Standard_Type R848_Standard)
{
...
static R848_ErrCode R848_IMR_Cross( struct r848_priv *priv,struct r848_sect_type* IQ_Pont, u8* X_Direct)
{
	int ret;
...
//-------------------------------------------------------------------------------------//
static R848_ErrCode R848_CompreStep( struct r848_priv *priv,struct r848_sect_type* StepArry, u8 Pace)
{
	int ret;
...
static R848_ErrCode R848_IMR_Iqcap( struct r848_priv *priv,struct r848_sect_type* IQ_Point)
{
    struct r848_sect_type Compare_Temp;
	int i = 0, ret;
...
static R848_ErrCode R848_IQ( struct r848_priv *priv,struct r848_sect_type* IQ_Pont)
{
	int ret;
	struct r848_sect_type Compare_IQ[3];
	u8   VGA_Count = 0;
...
// output: TRUE or FALSE
//----------------------------------------------------------------------------------------//
static R848_ErrCode R848_F_IMR( struct r848_priv *priv,struct r848_sect_type* IQ_Pont)
{
	int ret;
	struct r848_sect_type Compare_IQ[3];
	struct r848_sect_type Compare_Bet[3];
...
static u8 R848_Filt_Cal_ADC( struct r848_priv *priv,u32 IF_Freq, u8 R848_BW, u8 FilCal_Gap)
{
	int ret;
...
static R848_ErrCode R848_DVBS_Setting(struct r848_priv *priv)
{
	int ret;
	 u32	LO_KHz;
...
static R848_Sys_Info_Type R848_Sys_Sel( struct r848_priv *priv,R848_Standard_Type R848_Standard)
{
...
static R848_SysFreq_Info_Type R848_SysFreq_Sel(struct r848_priv *priv, R848_Standard_Type R848_Standard, u32 RF_freq)
{
...
static void r848_release(struct neumo_dvb_frontend *fe)
{
...
static int r848_init(struct neumo_dvb_frontend *fe)
{
	struct r848_priv *priv = fe->tuner_priv;
	int ret;
	u8 i;
...
static int r848_sleep(struct neumo_dvb_frontend *fe)
{
	struct r848_priv *priv = fe->tuner_priv;
	int ret = 0;
	dev_dbg(&priv->i2c->dev, "%s()\n", __func__);
...
static const struct neumo_dvb_tuner_ops r848_tuner_ops = {
	.info = {
		.name           = "Rafael R848",
