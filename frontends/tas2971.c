...
static int tas2971_read_ber(struct neumo_dvb_frontend *fe, u32 *ber)
{
...
static int tas2971_read_signal_strength(struct neumo_dvb_frontend *fe,
	u16 *signal_strength)
{
...
static int tas2971_read_snr(struct neumo_dvb_frontend *fe, u16 *snr)
{
...
/* unimplemented */
static int tas2971_read_ucblocks(struct neumo_dvb_frontend *fe, u32 *ucblocks)
{
	return 0;
}

static int tas2971_read_status(struct neumo_dvb_frontend *fe, enum fe_status *status)
{
...
static void tas2971_spi_read(struct neumo_dvb_frontend *fe, struct ecp3_info *ecp3inf)
{
...
static void tas2971_spi_write(struct neumo_dvb_frontend *fe,struct ecp3_info *ecp3inf)
{
	struct tas2971_priv *priv = fe->demodulator_priv;
	struct i2c_adapter *adapter = priv->base->i2c;
...
static void tas2971_mcu_read(struct neumo_dvb_frontend *fe, struct mcu24cxx_info *mcu24cxxinf)
{
...
static void tas2971_mcu_write(struct neumo_dvb_frontend *fe,struct mcu24cxx_info *mcu24cxxinf)
{
	struct tas2971_priv *priv = fe->demodulator_priv;
	struct i2c_adapter *adapter = priv->base->i2c;
...
static void tas2971_reg_i2c_read(struct neumo_dvb_frontend *fe, struct usbi2c_access *pi2cinf)
{
...
static void tas2971_reg_i2c_write(struct neumo_dvb_frontend *fe,struct usbi2c_access *pi2cinf)
{
	struct tas2971_priv *priv = fe->demodulator_priv;
	struct i2c_adapter *adapter = priv->base->i2c;
...
static int tas2971_set_voltage(struct neumo_dvb_frontend *fe,
...
static int tas2971_set_tone(struct neumo_dvb_frontend *fe,
...
static int tas2971_send_diseqc_msg(struct neumo_dvb_frontend *fe,
...
static int tas2971_diseqc_send_burst(struct neumo_dvb_frontend *fe,
	enum fe_sec_mini_cmd burst)
{
	return 0;
}

static void tas2971_release(struct neumo_dvb_frontend *fe)
{
	struct tas2971_priv *priv = fe->demodulator_priv;
...
static struct neumo_dvb_frontend_ops tas2971_ops;
...
struct neumo_dvb_frontend *tas2971_attach(const struct tas2101_config *cfg,
...
static int tas2971_initfe(struct neumo_dvb_frontend *fe)
{
	return 0;

}

static int tas2971_sleep(struct neumo_dvb_frontend *fe)
{

	return 0;
}

static int tas2971_set_frontend(struct neumo_dvb_frontend *fe)
{
	return 0;
...
static int tas2971_tune(struct neumo_dvb_frontend *fe, bool re_tune,
...
static enum neumo_dvbfe_algo tas2971_get_algo(struct neumo_dvb_frontend *fe)
{
	return DVBFE_ALGO_HW;
}

#ifndef TAS2971_USE_I2C_MUX
static int tas2971_i2c_gate_ctrl(struct neumo_dvb_frontend* fe, int enable)
{
	return 0;
