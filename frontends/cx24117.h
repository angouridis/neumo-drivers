...
struct cx24117_config {
	...
	/* lnb power control */
	void (*lnb_power)(struct neumo_dvb_frontend *fe, int demod, int onoff);
};

#if IS_REACHABLE(CONFIG_DVB_CX24117)
extern struct i2c_adapter *cx24117_get_i2c_adapter(struct neumo_dvb_frontend *fe);
extern struct neumo_dvb_frontend *cx24117_attach(
	struct cx24117_config *config,
	struct i2c_adapter *i2c);
#else
static inline struct neumo_dvb_frontend *cx24117_attach(
	struct cx24117_config *config,
	struct i2c_adapter *i2c)
{
